...
<table id="page-header" width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr class="header">
  ...
  <td align="right" valign="bottom">powered by <a href="http://pear.php.net/">PEAR</a>::<a href="http://pear.php.net/package/Net_NNTP/">Net_NNTP</a> v<?php echo @\DariusIII\NetNntp\Client::getPackageVersion(); ?></td>
 </tr>
 <tr class="subheader">
